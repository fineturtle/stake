              ...
              <div className="position-relative">
                ...
                <div className="position-absolute w-100 bottom-0">
                  <div className="d-flex justify-content-between fs-16">
                    <div>FINE-VIP: {props.walletBalances[2] ? Number(props.walletBalances[2]).toFixed(2) : 0}</div>
              ...
              <div className="border-dot flex-1" style={{ padding: "24px 14px" }}>
                <div className="d-flex gap-2 align-items-center">
                  ...
                  <div>
                    ...
                    <div className="fs-18">{props.walletBalances[2] ? Number(props.walletBalances[2]).toFixed(2) : 0.00} <span className="fs-12">FV</span></div>
                  </div>
                </div>
        ...
        <div className="d-flex mt-4 flex-md-row flex-column" style={{ gap: "52px" }}>
            ...
            <div className="histories">
              ...
              <div className="fw-800">{props.claimAmount > 0 ? props.claimAmount : "0.00"} USDC</div>
              {
                (props.claimHistory).length > 0 ?
                  (props.claimHistory)?.map((row, key) => {
                    if (row[0] > 0) {
                      ...
                      return (
                        <>
                          <div className="stackTx d-flex align-items-center w-100 justify-content-between px-4 py-2 my-4" key={key}>
          ...
          <div className="flex-1">
            ...
            <div className="histories">
              ...
              <div className="fw-800">{props.stakedBalance > 0 ? Number(props.stakedBalance).toFixed(2) : "0.00"} FINE-VIP</div>
              {
                (props.stakingHistory).length > 0 ?
                  ...
                  props.stakingHistory?.map((row, i) => {
                    ...
                    return (
                      <div className="stackTx d-flex align-items-center w-100 justify-content-between px-4 py-2 my-4" key={i}>
                        <div className="d-flex flex-column border-right pe-3">
                          <div className="fc-929EAE fs-14">{month}</div>
                          <div className="fw-800 fs-12">{day}</div>
                        </div>
